...
<html:form action="/configThemaData" focus="${focus}">
        ...
        <table>
            <tr>
                ...
                <td colspan="3">
                    ...
                    <html:submit property="updateBasisregels" styleClass="knop postCheckboxTable"><fmt:message key="configthemadata.updatebasisregels.button"/></html:submit>
                    </td>
                </tr>
            </table>
        </div>
    ...
    <div style="float: right; clear: both; width: 940px; margin-right: 20px; margin-bottom: 5px;">
        <div style="float: left; margin-left: 10px;">
            <input type="checkbox" id="advancedToggle" data-cookie-key="themadata" /> Toon geavanceerde opties
        </div>
