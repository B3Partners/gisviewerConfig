...
<div class="infobalk">
    <div class="infobalk_description">Stap 5</div>
...
<html:form action="/wizardZoekConfiguratie">
    ...
    <div class="wizardQuestionBlock">
        ...
        <fmt:message key="configzoekconfiguratieveld.naam"/>: <input type="text" name="naam"/>
    </div>
    <div class="wizardButtonBar">
        <html:submit property="step4"><fmt:message key='button.previous'/></html:submit>
        <html:submit property="step5"><fmt:message key='button.next'/></html:submit>
    </div>
</html:form>